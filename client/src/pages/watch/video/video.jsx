    ...
    return (
        <div className='videobody'>
            <div className='videotext'>
                <iframe className='videoplayer' width="560" height="315" src="https://www.youtube.com/embed/aRz0QZc8TDE" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                <div className='text'>
